...
This project serves as a quick start to integrate Spring Boot with Testcontainers for testing purposes. It includes several dependencies and tools to set up a robust development, testing, and monitoring environment.

## Key Features

### Spring Boot Foundation
- Uses Spring Boot 3.1.3.
- Includes starters for Web, Data JPA (database access), and Validation.
- Provides REST API capabilities with database interaction.

### Database Support and Versioning
- PostgreSQL as the database.
- Flyway for automated database migration and version control.

### Testcontainers Integration
- Dependencies for Testcontainers, including PostgreSQL testcontainers and JUnit Jupiter.
- Provides isolated, containerized PostgreSQL for reliable and isolated integration testing.

### Monitoring
- Uses Spring Boot Actuator with Micrometer Prometheus registry.
- Enables runtime metrics exposure for Prometheus scraping and visualization with Grafana.

### Developer Convenience
- Spring Boot DevTools for hot reload during development to increase productivity.

### Testing Setup
- Testing dependencies include Spring Boot Starter Test and Rest Assured for unit, integration, and REST API testing.
- Selenium and Chrome Driver for browser automation testing.

## Summary

The project enables rapid development of Spring Boot REST APIs with robust testing through containerized PostgreSQL databases, automatic database schema management, monitoring with Prometheus metrics, and comprehensive testing solutions including API and UI automation. This enhances reliability, observability, and development efficiency.
...
```
## 2. Setup Project
* Clone the repository `git clone https://github.com/testcontainers/springboot3-all-in-one.git && cd springboot3-all-in-one`
* Open the **springboot3-all-in-one** project in your favorite IDE.
...
The **springboot3-all-in-one** project is a SpringBoot REST API using Java 17, Spring Data JPA, PostgreSQL, and Gradle/Maven.
